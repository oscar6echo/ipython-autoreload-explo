# this file is derived from https://github.com/ipython/ipython/blob/master/IPython/extensions/autoreload.py
# A few commented changes are added in order for the autoreload magic to work with class new methods
...
class AutoreloadMagics(Magics):
    ...
    @line_magic
    def myautoreload(self, parameter_s=''):
